...
# Sort to ensure strictly increasing temperature
...
# Sort stress to ensure increasing order
sort_idx2 = np.argsort(y1)
cs_StressToP = CubicSpline(y1[sort_idx2], x1[sort_idx2], extrapolate=True)
